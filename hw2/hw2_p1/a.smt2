...
; Define own abs function
(define-fun myabs ((x Real)) Real
(ite (> x 0) x (- x))
)
; Define max of abs input function
(define-fun absmax ((x Real) (y Real)) Real
(ite (< (myabs x) (myabs y)) (myabs y) (myabs x))
)
;========================================================================
